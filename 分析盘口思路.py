...
match_map = {
    # "group1": [],
    "group2": ["英超", "英甲", "西甲", "意甲", "法甲", "德甲", "葡超", "荷甲", "英冠", "英足总杯", "欧冠", "欧罗巴", "德国杯", "意超杯", "意杯", "法国杯", "西班牙杯", "非洲杯", "欧洲杯", "解放者杯", "西乙", "西丙1", "西丙2", "西丙3", "西丙4", "西协甲", "意乙", "意丙1A", "意丙1B", "法乙", "法丙", "德乙", "荷乙", "比杯", "瑞典超", "丹超", "瑞士超", "克罗甲", "塞甲联", "波甲", "波乙", "苏冠", "苏甲", "土超", "土甲", "苏超", "瑞士甲", "丹甲", "罗甲", "英乙", "比乙", "保超", "挪超", "挪甲", "德东北", "爱超", "爱甲", "黑山甲", "阿巴超", "埃及甲", "摩洛超", "阿尔及甲", "捷甲", "捷克乙", "黑山甲", "阿甲", "巴甲", "巴圣锦", "巴乙", "阿乙", "乌拉超", "智利甲", "厄瓜多尔甲", "秘鲁甲", "巴拉圭联", "墨西联", "墨西乙", "哥斯甲", "哥甲", "美职联", "澳超", "日职", "日联杯", "K1联赛", "K2联赛", "印度超", "印度甲", "印尼超", "澳南超", "澳维超", "越南联", "伊朗超", "伊朗甲", "阿联超", "马来超", "泰超", "巴西杯", "欧会杯", "乌兹超", "冰岛联", "沙特联", "波黑超", "澳昆超", "中超", "中甲", "智甲", "斯洛文甲", "南非超", "冰岛超", "卡塔联", "亚冠杯", "希腊超A", "厄甲", "奥甲", "奥乙"],
    "group_inaccuracy": ["韩足杯", "日职乙", "乌超", "葡甲", "比甲"]
}
        ...
        if match["match_round"] >= match["team_count"] / 2 + 1:
            if match["home_team_rank"] <= match["visit_team_rank"] - (match["team_count"] / 2) and match["home_score"] >= match["visit_score"] + 15:
                if match["instant_pan_most"] >= -0.25:
                    print(f"\033[1;30;45m警惕：主队排名{match['home_team_rank']}，客队排名{match['visit_team_rank']}，两者分差{match['home_score']-match['visit_score']}，主队盘口非常便宜！\033[0m")
                    result_dic = {
                        "赢": 0,
                        "输": 0,
                        "走": 0
            ...
            if match["home_team_rank"] >= match["visit_team_rank"] + 10 and match["visit_score"] >= match["home_score"] + 15:
                if match["instant_pan_most"] <= 0:
                    print(f"\033[1;30;45m警惕：主队排名{match['home_team_rank']}，客队排名{match['visit_team_rank']}，两者分差{match['visit_score'] - match['home_score']}，客队盘口非常便宜！\033[0m")
                    result_dic = {
                        "赢": 0,
                        "输": 0,
                        "走": 0
...
def analyse_match():
    ...
    for tr in tr_list:
        ...
        if time_diff < -60 * 60 * 0:
            continue
        if time_diff > 3600 * 4 and is_start == "未":
            break
